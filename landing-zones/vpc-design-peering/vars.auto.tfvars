vpc_map = {
  vpc-prod-10-0 = {
    region = "RNN"
    vnets = {
      vnet-10-0-1 = { cidr = "10.0.1.0/24", snat = true, tags = ["web"] }
      vnet-10-0-2 = {
        cidr     = "10.0.2.0/24"
        snat     = false
        tags     = ["data"]
        ...
        firewall_rules = [
          { direction = "in", protocol = "tcp", source_cidr = "10.0.1.0/24", port = "80", description = "HTTP depuis web" },
          { direction = "in", protocol = "tcp", source_cidr = "10.0.1.0/24", port = "443", description = "HTTPS depuis web" },
          { direction = "in", protocol = "tcp", source_cidr = "10.0.1.0/24", port = "5432", description = "PostgreSQL depuis web" },
  ...
  vpc-prod-10-1 = {
    region = "RNN"
    vnets = {
      vnet-10-1-1 = { cidr = "10.1.1.0/24", snat = false, tags = ["web"] }
      vnet-10-1-2 = { cidr = "10.1.2.0/24", snat = false, tags = ["data"] }
    }
  }
  vpc-staging-10-2 = {
    region = "RNN"
